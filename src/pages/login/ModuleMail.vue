        ...
        <div class="login-account">
            <el-form-item prop="username">
                <el-input class="login-input" v-model="param.mailNumber" placeholder="请输入邮箱">
                    <template #prepend>
                        <el-button icon="Message" class="login-icon" style="margin-top: -0.3rem; color: #7ec3fb;"></el-button>
                    </template>
                </el-input>
            </el-form-item>
            <div style="display: flex; justify-content: space-between;">
                <el-input v-model="param.captcha" style="width: 18rem;" placeholder="请输入验证码"></el-input>
                <el-button type="primary" class="basic-btn get-message-captcha common-based-btn" @click="getCaptcha()">验证码</el-button>
            </div>
            <div class="login-area">
                <el-button type="primary" class="basic-btn login-btn common-based-btn" @click="mailLogin()">登 录</el-button>
            </div>
        </div>
    </el-form>
</template>
